...
//    public List<FileBean> findByUND(String user_name);
    ...
    @Query(value = "select * from sqsx_file where sqsx_file.isdel = 0 and sqsx_file.tag0 =?1 ",nativeQuery = true)
    List<FileBean> findByTG0(String tag0);
    @Query(value = "select * from sqsx_file where sqsx_file.isdel = 0 and sqsx_file.tag1 =?1 ",nativeQuery = true)
    List<FileBean> findByTG1(String tag1);
    @Query(value = "select * from sqsx_file where sqsx_file.isdel = 0 and sqsx_file.tag2 =?1 ",nativeQuery = true)
    ...
    public FileBean findbyName(String filename);
